$(document).ready(function() {
  ...
  $(".btn-main").hover(function(){
    event.preventDefault();
      $(this).css("background-color", "#1B6500");
      $(this).css("border-color", "#1B6500");
    }, function(){
      $(this).css("background-color", "#238200");
      $(this).css("border-color", "#238200");
    });

    $(".btn-supporting").hover(function(){
    event.preventDefault();
  ...
  // Mobile (Compressed) Navbar Dropdown Helper Function
  ...
  // Top Learn More Button Functionality - when this form is submitted, redirect to another 
  // state-specific info view. (Functionality is like an SPA but only with simple JS/jQuery code.)

  $("#pick-state").submit(function(event) {
    event.preventDefault();
  ...
  // Supporting Learn More Buttons Functionality - when these buttons are clicked, redirect to another 
  // detailed How it Works view. (Functionality is like an SPA but only with simple JS/jQuery code.)

    $(".btn-supporting").click(function(event) {
    event.preventDefault();

    $(".how-it-works-view").removeClass("hidden");
